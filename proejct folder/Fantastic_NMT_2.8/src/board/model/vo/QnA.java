...
public class QnA implements Serializable{
	...
	public QnA(int boardNo, int memberCode, String boardCate, String boardTItle, String boardContent,
	...
	public String toString() {
		return "QnA [boardNo=" + boardNo + ", memberCode=" + memberCode + ", boardCate=" + boardCate + ", boardTItle="
				+ boardTItle + ", boardContent=" + boardContent + ", boardOrigin=" + boardOrigin + ", boardRename="
				+ boardRename + ", boardDate=" + boardDate + ", boardReadcnt=" + boardReadcnt + ", boardLevel="
				+ boardLevel + ", boardRef=" + boardRef + "]";
	}

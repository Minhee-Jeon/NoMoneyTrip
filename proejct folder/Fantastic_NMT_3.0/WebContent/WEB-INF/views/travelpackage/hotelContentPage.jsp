...
<section>
	...
	<div class="hotelcontent-wrap">
		<div id="hotelcontent-section-info">
			<div class="img_album">
			        <div class="img_big">
			        ...
			        <div class="img_album_mini">
			            <div class="mini_img" onclick="currenSlide(1)"><img class="<%=request.getContextPath() %>/images/hotel/<%=h.getHotelCode() %>.1.jpg" width="180px"></div>
			            <div class="mini_img" onclick="currenSlide(2)"><img class="<%=request.getContextPath() %>/images/hotel/<%=h.getHotelCode() %>.2.jpg" width="180px"></div>
			            <div class="mini_img" onclick="currenSlide(3)"><img class="<%=request.getContextPath() %>/images/hotel/<%=h.getHotelCode() %>.3.jpg" width="180px"></div>
			            <div class="mini_img" onclick="currenSlide(4)"><img class="<%=request.getContextPath() %>/images/hotel/<%=h.getHotelCode() %>.4.jpg" width="180px"></div>
			            <div class="mini_img" onclick="currenSlide(5)"><img class="<%=request.getContextPath() %>/images/hotel/<%=h.getHotelCode() %>.5.jpg" width="180px"></div>
			        </div>
   				</div>
		</div>
	</div>

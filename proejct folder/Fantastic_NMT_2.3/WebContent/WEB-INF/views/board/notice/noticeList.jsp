...
<!--                     <i class="fas fa-plus" onclick="more();"></i>  -->
        ...
        <div class="qna_wrap">
            <div class="qna_bar">
                ...
                <i class="fas fa-plus" onclick="location.href='<%=request.getContextPath()%>/board/qnaWrite'"></i>
           ...
           <%--  <table class="qna_table">
             ...
             <table class="qna_table">
             <tr class="qna_q">
             	<td><%=q.getBoardTItle() %><i class="fas fa-angle-down scroll_bnt"></i><i class="fas fa-angle-up scroll_up_bnt"></i></td>
             </tr>
            <tr class="bg_scroll">
            	<td ><%=q.getBoardContent() %>
            		<i class="far fa-edit contentIcon" onclick="location.href = '<%=request.getContextPath()%>/board/QnaUpdate?boardNo=<%=q.getBoardNo()%>'"></i>
            		<i class="far fa-trash-alt contentIcon" onclick="deleteQnA();"></i></td>
            </tr>
             </table>
             <form action="<%=request.getContextPath()%>/board/QnADelete" name="QnaDelFrm">

...
public class ReviewWriteEndServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		//1.saveDirectory: 업로드한 파일의 절대경로
				...
				String mCode = multiReq.getParameter("memberCode");
				System.out.println(mCode + ","+boardTitle+","+boardContent);
				...
				Review r = new Review(0, mCode, "B1", boardTitle, boardContent, boardOrigin, boardRename, null, 0, 1, 0);
